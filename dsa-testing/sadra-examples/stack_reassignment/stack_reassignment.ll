; ModuleID = 'dsa-testing/sadra-examples/stack_reassignment/stack_reassignment.c'
source_filename = "dsa-testing/sadra-examples/stack_reassignment/stack_reassignment.c"
