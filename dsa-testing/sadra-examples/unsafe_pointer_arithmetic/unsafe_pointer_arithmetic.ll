; ModuleID = 'dsa-testing/sadra-examples/unsafe_pointer_arithmetic/unsafe_pointer_arithmetic.c'
source_filename = "dsa-testing/sadra-examples/unsafe_pointer_arithmetic/unsafe_pointer_arithmetic.c"
