; ModuleID = 'dsa-testing/seahorn-examples/complete_callgraph_6/complete_callgraph_6.c'
source_filename = "dsa-testing/seahorn-examples/complete_callgraph_6/complete_callgraph_6.c"
...
define dso_local i32 @f1() #0 {
  ...
  %3 = call i32 @use(i32 (i32, i32)* noundef @add)
  store i32 %3, i32* %1, align 4
  %4 = call i32 @use(i32 (i32, i32)* noundef @sub)
...
define dso_local i32 @f2() #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = call i32 @use(i32 (i32, i32)* noundef @mul)
  store i32 %3, i32* %1, align 4
  %4 = call i32 @use(i32 (i32, i32)* noundef @mul)
  store i32 %4, i32* %2, align 4
  %5 = load i32, i32* %1, align 4
  %6 = load i32, i32* %2, align 4
  %7 = add nsw i32 %5, %6
