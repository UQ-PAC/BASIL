; ModuleID = 'dsa-testing/seahorn-examples/complete_callgraph_3/complete_callgraph_3.c'
source_filename = "dsa-testing/seahorn-examples/complete_callgraph_3/complete_callgraph_3.c"
