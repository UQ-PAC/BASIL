; ModuleID = 'dsa-testing/seahorn-examples/test-ret-struct/test-ret-struct.c'
source_filename = "dsa-testing/seahorn-examples/test-ret-struct/test-ret-struct.c"
...
@.str.1 = private unnamed_addr constant [63 x i8] c"dsa-testing/seahorn-examples/test-ret-struct/test-ret-struct.c\00", align 1
...
11:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([63 x i8], [63 x i8]* @.str.1, i64 0, i64 0), i32 noundef 20, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #2
  unreachable
