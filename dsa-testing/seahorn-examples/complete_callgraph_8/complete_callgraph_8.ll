; ModuleID = 'dsa-testing/seahorn-examples/complete_callgraph_8/complete_callgraph_8.c'
source_filename = "dsa-testing/seahorn-examples/complete_callgraph_8/complete_callgraph_8.c"
...
8:                                                ; preds = %2
  ...
  %11 = add nsw i32 %10, 1
  %12 = call i32 @bar(%struct.class_t* noundef %9, i32 noundef %11)
...
8:                                                ; preds = %2
  ...
  %11 = call i32 @foo(%struct.class_t* noundef %10, i32 noundef 10)
  %12 = add nsw i32 %9, %11
  store i32 %12, i32* %3, align 4
  br label %16
