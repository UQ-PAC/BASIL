; ModuleID = 'dsa-testing/seahorn-examples/complete_callgraph_4/complete_callgraph_4.c'
source_filename = "dsa-testing/seahorn-examples/complete_callgraph_4/complete_callgraph_4.c"
...
8:                                                ; preds = %2
  ...
  %15 = call i32 %13(%struct.class_t* noundef %14, i32 noundef 10)
  %16 = add nsw i32 %9, %15
  store i32 %16, i32* %3, align 4
  br label %20
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @bar2(%struct.class_t* noundef %0, i32 noundef %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca %struct.class_t*, align 8
  %5 = alloca i32, align 4
  store %struct.class_t* %0, %struct.class_t** %4, align 8
...
define dso_local i32 @main() #0 {
  ...
  %11 = bitcast {}** %10 to i32 (%struct.class_t*, i32)**
  %12 = load i32 (%struct.class_t*, i32)*, i32 (%struct.class_t*, i32)** %11, align 8
  %13 = call i32 %12(%struct.class_t* noundef %2, i32 noundef 42)
  store i32 %13, i32* %3, align 4
  ret i32 0
}
