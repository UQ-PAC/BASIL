...
assignment_stmt : 'Stmt_Assign' OPEN_PAREN lexpr COMMA expr CLOSE_PAREN #Assign
...
lexpr : 'LExpr_Var' OPEN_PAREN (SSYMBOL | METHOD) CLOSE_PAREN #LExprVar
...
expr : 'Expr_Var' OPEN_PAREN (SSYMBOL | METHOD) CLOSE_PAREN #ExprVar 
     | 'Expr_TApply' OPEN_PAREN METHOD COMMA OPEN_BRACKET (OPEN_PAREN targs CLOSE_PAREN (SCOLON OPEN_PAREN targs CLOSE_PAREN)*)? CLOSE_BRACKET
                     COMMA OPEN_BRACKET (OPEN_PAREN expr CLOSE_PAREN (SCOLON OPEN_PAREN expr CLOSE_PAREN)*)? CLOSE_BRACKET CLOSE_PAREN #ExprTApply
     | 'Expr_Slices' OPEN_PAREN expr COMMA OPEN_BRACKET OPEN_PAREN slice_expr CLOSE_PAREN CLOSE_BRACKET CLOSE_PAREN #ExprSlices
