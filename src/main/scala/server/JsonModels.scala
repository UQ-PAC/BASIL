...
case class NodeData(id: String, label: String, isEntry: Boolean = false)

case class EdgeData(id: String, source: String, target: String, label: Option[String] = None)

case class ProcedureGraph(nodes: List[NodeData], edges: List[EdgeData])
