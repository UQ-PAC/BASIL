 ...
 */
private def joinFunction(blockAbstractState: util.HashMap[FlowGraph.Block, util.HashMap[Var, Expr]], node: FlowGraph.Block, predecessorNode: FlowGraph.Block) = { // TODO
  true
}
