...
//        block.jumps.foreach {
//          case g: GoTo =>
//            val target: Statement = blocks(g.target.label).data.statements.head
//            cfg.addNode(nodePool.get(target))
//            cfg.addEdge(lastAdded, nodePool.getLatestAdded)
//            nodePool.setLatestAdded(lastAdded)
//          case d: DirectCall =>
//            cfg.addNode(nodePool.get(d))
//            cfg.addEdge(lastAdded, nodePool.getLatestAdded)
//          case i: IndirectCall =>
