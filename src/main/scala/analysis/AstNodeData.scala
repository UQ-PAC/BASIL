...
//    * @see
//    *   [[tip.analysis.DeclarationAnalysis]]
//    */
//  type DeclarationData = Map[LocalVar, ADeclaration]
//
//  /** Map from AST node to type, if available.
//    * @see
//    *   [[tip.analysis.TypeAnalysis]]
//    */
//  type TypeData = Map[AstNode, Option[Type]]
//
//  /** Implicitly make declaration data available on identifier AST nodes.
//    *
//    * To novice Scala programmers: This "implicit class" has the effect that every instance of `AIdentifier` effectively
//    * gets an extra field `declaration` (provided that this class has been imported). Note that the value of the field
//    * is obtained via the implicit parameter `data`. For more information about implicit classes in Scala, see
