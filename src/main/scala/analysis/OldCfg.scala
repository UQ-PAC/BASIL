...
//         //println(s"======VISITING $blockName======")
//         //println(s"Included statements")
//         //statementNodes.foreach(stmt => println(stmt))
...
//     println("Showing blocks")
//     for (proc <- prog.procedures) {
//       println(s"========Procedure $proc=========")
//       for (block <- proc.blocks) {
//         println(s"Block label: ${block.label}")
//         println(s"Block addr : ${block.address}")
//       }
//     }
