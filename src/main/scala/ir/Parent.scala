...
trait HasParent[T]:
  ...
  /** Update any IL control-flow links implied by this relation. NOT necessarily idempotent. For example;
  ...
  /** Update any IL control-flow links implied by this relation. NOT necessarily idempotent.
    */
  protected[this] def unlinkParent(): Unit = ()

  /** Remove this element's parent and update any IL control-flow links implied by this relation. Is idempotent.
    */
  ...
  /** Set this element's parent and update any IL control-flow links implied by this relation. If another parent is
    * already set then it will be de-parented and unlinked from that first. Is idempotent.
    */
