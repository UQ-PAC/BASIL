...
//        BitVectorEval.smt_extract(e.end - 1, e.start + 1, eval(e.body, env))
      ...
      case bin: BinaryExpr =>
        ...
        bin.op match {
          ...
          case BVNAND   => BitVectorEval.smt_bvnand(left, right)
          case BVNOR    => BitVectorEval.smt_bvnor(left, right)
          case BVXOR    => BitVectorEval.smt_bvxor(left, right)
          case BVXNOR   => BitVectorEval.smt_bvxnor(left, right)
          ...
          case BVSMOD   => BitVectorEval.smt_bvsmod(left, right)
          case BVASHR   => BitVectorEval.smt_bvashr(left, right)
          case BVULE    => BitVectorEval.smt_bvule(left, right)
          case BVUGT    => BitVectorEval.smt_bvugt(left, right)
          case BVUGE    => BitVectorEval.smt_bvuge(left, right)
          case BVSLT    => BitVectorEval.smt_bvslt(left, right)
          case BVSLE    => BitVectorEval.smt_bvsle(left, right)
          case BVSGT    => BitVectorEval.smt_bvsgt(left, right)
          case BVSGE    => BitVectorEval.smt_bvsge(left, right)
