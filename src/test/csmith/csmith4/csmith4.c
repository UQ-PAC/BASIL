...
static volatile uint8_t g_5 = 249UL;
static int64_t g_10 = 0x6EC7516A205B2906LL;
static volatile int32_t g_11 = (-1L);
static volatile int8_t g_12 = 0x06L;
static uint64_t g_13 = 0xEF66B17B722BA7B7LL;
...
static uint32_t func_1(void)
{
    int32_t l_8 = 8L;
    int32_t *l_9[2];
    uint32_t l_16 = 0x61FC42FFL;
    int i;
    for (i = 0; i < 2; i++)
        l_9[i] = &g_2;
    for (g_2 = 28; (g_2 <= (-26)); g_2 -= 9)
    {
        g_5--;
    }
    g_2 |= l_8;
