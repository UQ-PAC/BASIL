...
bap "clang/$name.out" -d adt:"clang/$name.adt" -d bir:"clang/$name.bir"
...
bap "clang_no_plt_no_pic/$name.out" -d adt:"clang_no_plt_no_pic/$name.adt" -d bir:"clang_no_plt_no_pic/$name.bir"
...
bap "clang_O2/$name.out" -d adt:"clang_O2/$name.adt" -d bir:"clang_O2/$name.bir"
...
bap "clang_pic/$name.out" -d adt:"clang_pic/$name.adt" -d bir:"clang_pic/$name.bir"
...
bap "gcc/$name.out" -d adt:"gcc/$name.adt" -d bir:"gcc/$name.bir"
...
bap "gcc_no_plt_no_pic/$name.out" -d adt:"gcc_no_plt_no_pic/$name.adt" -d bir:"gcc_no_plt_no_pic/$name.bir"
...
bap "gcc_O2/$name.out" -d adt:"gcc_O2/$name.adt" -d bir:"gcc_O2/$name.bir"
...
bap "gcc_pic/$name.out" -d adt:"gcc_pic/$name.adt" -d bir:"gcc_pic/$name.bir"
