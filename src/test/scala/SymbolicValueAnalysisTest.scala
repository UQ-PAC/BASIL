import analysis.data_structure_analysis.{AddressRange, Heap, Loaded, Par, Ret, SymBase, SymValueSet, SymbolicValueDomain}
import boogie.SpecGlobal
import ir.Endian.LittleEndian
import ir.dsl.{block, directCall, goto, proc, prog, ret}
import ir.{BVADD, BinaryExpr, BitVecLiteral, BitVecType, DirectCall, Endian, IntraProcIRCursor, LocalAssign, LocalVar, MemoryLoad, MemoryStore, Procedure, Program, Register, SharedMemory, cilvisitor, computeDomain, transforms}
