...
procedure {:extern} rely();
  ...
  free ensures (memory_load8_le(mem, 2512bv64) == 1bv8);
  free ensures (memory_load8_le(mem, 2513bv64) == 0bv8);
  free ensures (memory_load8_le(mem, 2514bv64) == 2bv8);
  free ensures (memory_load8_le(mem, 2515bv64) == 0bv8);
...
procedure #free();
  ...
  free requires (memory_load8_le(mem, 2512bv64) == 1bv8);
  free requires (memory_load8_le(mem, 2513bv64) == 0bv8);
  free requires (memory_load8_le(mem, 2514bv64) == 2bv8);
  free requires (memory_load8_le(mem, 2515bv64) == 0bv8);
  ...
  free ensures (memory_load8_le(mem, 131167bv64) == 0bv8);
{
  ...
  lmain:
    ...
    assume {:captureState "%000003a2"} true;
    ...
    assume {:captureState "%000003b4"} true;
    ...
    call rely();
    assert (L(mem, bvadd64(R0, 5bv64)) ==> Gamma_R1);
    mem, Gamma_mem := memory_store8_le(mem, bvadd64(R0, 5bv64), R1[8:0]), gamma_store8(Gamma_mem, bvadd64(R0, 5bv64), Gamma_R1);
    ...
    goto l000003f6;
  l000003f6:
    assume {:captureState "l000003f6"} true;
    ...
    goto l00000434;
  l00000434:
    assume {:captureState "l00000434"} true;
  ...
  l0000046d:
    ...
    assume {:captureState "%0000048b"} true;
    ...
    assume {:captureState "%00000499"} true;
    R0, Gamma_R0 := 131072bv64, true;
    R0, Gamma_R0 := bvadd64(R0, 128bv64), Gamma_R0;
    call rely();
    R19, Gamma_R19 := memory_load64_le(mem, R0), (gamma_load64(Gamma_mem, R0) || L(mem, R0));
    ...
    call rely();
    R0, Gamma_R0 := memory_load64_le(mem, R0), (gamma_load64(Gamma_mem, R0) || L(mem, R0));
    R30, Gamma_R30 := 2444bv64, true;
    call strlen();
    goto l000004c6;
  l000004c6:
    assume {:captureState "l000004c6"} true;
    R2, Gamma_R2 := R0, Gamma_R0;
    R1, Gamma_R1 := 1bv64, true;
    R0, Gamma_R0 := R19, Gamma_R19;
    R30, Gamma_R30 := 2460bv64, true;
    call memset();
    goto l000004df;
  l000004df:
    ...
    call rely();
    R0, Gamma_R0 := memory_load64_le(mem, R0), (gamma_load64(Gamma_mem, R0) || L(mem, R0));
    R30, Gamma_R30 := 2476bv64, true;
    call #free();
    goto l000004f9;
  l000004f9:
    assume {:captureState "l000004f9"} true;
