...
procedure main()
  ...
  free requires (memory_load8_le(mem, 2108bv64) == 1bv8);
  free requires (memory_load8_le(mem, 2109bv64) == 0bv8);
  free requires (memory_load8_le(mem, 2110bv64) == 2bv8);
  ...
  free requires (memory_load8_le(mem, 131032bv64) == 192bv8);
  free requires (memory_load8_le(mem, 131033bv64) == 6bv8);
  ...
  free ensures (R31 == old(R31));
{
  ...
  lmain:
    ...
    R30, Gamma_R30 := 1740bv64, true;
    call get_secret();
    goto l000001ea;
  l000001ea:
    R1, Gamma_R1 := 131072bv64, true;
    call rely();
    assert (L(mem, bvadd64(R1, 72bv64)) ==> Gamma_R0);
    mem, Gamma_mem := memory_store64_le(mem, bvadd64(R1, 72bv64), R0), gamma_store64(Gamma_mem, bvadd64(R1, 72bv64), Gamma_R0);
    R30, Gamma_R30 := 1752bv64, true;
    call #free();
    goto l000001ff;
  l000001ff:
