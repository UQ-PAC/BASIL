    ...
    if (diffContainerRef.current) {
      ...
      if (targetLineElement) {
        ...
        lineNumbers.forEach((td) => {
          ...
          if (
            !isNaN(currentTdNumber) &&
            currentTdNumber < lineNumber &&
            currentTdNumber > closestExistingLine
          ) {
        ...
        if (closestExistingLine !== -1) {
          console.log(
            `Scrolling to closest existing line: ${closestExistingLine}`
          );
          ...
          if (fallbackTargetElement) {
            ...
            if (row) {
              ...
              fallbackTargetElement.scrollIntoView({
                behavior: 'smooth',
                block: 'center',
              });
            }
          ...
          console.warn(
            `No suitable line found to scroll to, neither exact nor a previous one.`
          );
        }
      }
    }
