; ModuleID = '/host/dsa/split/split.c'
source_filename = "/host/dsa/split/split.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

@x = common dso_local global i32 0, align 4, !dbg !0
@y = common dso_local global i32* null, align 8, !dbg !6
@array = internal global [10 x i32] [i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9], align 4, !dbg !11

; Function Attrs: noinline nounwind optnone
define dso_local i32 @main(i32 %0) #0 !dbg !20 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 0, i32* %2, align 4
  store i32 %0, i32* %3, align 4
  call void @llvm.dbg.declare(metadata i32* %3, metadata !23, metadata !DIExpression()), !dbg !24
  store i32* @x, i32** @y, align 8, !dbg !25
  %4 = load i32, i32* getelementptr inbounds ([10 x i32], [10 x i32]* @array, i64 0, i64 1), align 4, !dbg !26
  ret i32 %4, !dbg !27
}
...
!20 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 5, type: !21, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!21 = !DISubroutineType(types: !22)
!22 = !{!10, !10}
!23 = !DILocalVariable(name: "r", arg: 1, scope: !20, file: !8, line: 5, type: !10)
!24 = !DILocation(line: 5, column: 14, scope: !20)
!25 = !DILocation(line: 6, column: 7, scope: !20)
!26 = !DILocation(line: 7, column: 12, scope: !20)
