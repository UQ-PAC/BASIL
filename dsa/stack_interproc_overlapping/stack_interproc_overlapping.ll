; ModuleID = '/host/dsa/stack_interproc_overlapping/stack_interproc_overlapping.c'
source_filename = "/host/dsa/stack_interproc_overlapping/stack_interproc_overlapping.c"
...
define dso_local i32 @main() #0 !dbg !28 {
  ...
  %2 = alloca %struct.str, align 8
  call void @llvm.dbg.declare(metadata %struct.str* %1, metadata !32, metadata !DIExpression()), !dbg !33
  %3 = getelementptr inbounds %struct.str, %struct.str* %1, i32 0, i32 0, !dbg !34
  store i64 4, i64* %3, align 8, !dbg !35
  call void @llvm.dbg.declare(metadata %struct.str* %2, metadata !36, metadata !DIExpression()), !dbg !37
  %4 = getelementptr inbounds %struct.str, %struct.str* %2, i32 0, i32 0, !dbg !38
  store i64 3, i64* %4, align 8, !dbg !39
  %5 = getelementptr inbounds %struct.str, %struct.str* %2, i32 0, i32 2, !dbg !40
  store i64 10, i64* %5, align 8, !dbg !41
  call void @set_fields(%struct.str* %2), !dbg !42
  ret i32 0, !dbg !43
}
...
!1 = !DIFile(filename: "/host/dsa/stack_interproc_overlapping/stack_interproc_overlapping.c", directory: "/")
!2 = !{}
...
!8 = !DIFile(filename: "/host/dsa/stack_interproc_overlapping/stack_interproc_overlapping.c", directory: "")
...
!28 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 15, type: !29, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!29 = !DISubroutineType(types: !30)
!30 = !{!31}
!31 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!32 = !DILocalVariable(name: "push", scope: !28, file: !8, line: 17, type: !12)
!33 = !DILocation(line: 17, column: 9, scope: !28)
!34 = !DILocation(line: 18, column: 10, scope: !28)
!35 = !DILocation(line: 18, column: 12, scope: !28)
!36 = !DILocalVariable(name: "stack", scope: !28, file: !8, line: 19, type: !12)
!37 = !DILocation(line: 19, column: 9, scope: !28)
!38 = !DILocation(line: 20, column: 11, scope: !28)
!39 = !DILocation(line: 20, column: 13, scope: !28)
!40 = !DILocation(line: 21, column: 11, scope: !28)
!41 = !DILocation(line: 21, column: 13, scope: !28)
!42 = !DILocation(line: 22, column: 5, scope: !28)
!43 = !DILocation(line: 23, column: 1, scope: !28)
